...
function updateCartTotal() {
  ...
  var cartRows = cartItemContainers.querySelectorAll(".cart-row");
  ...
  for (var j = 0; j < cartRows.length; j++) {
    ...
    var cart_price = parseFloat(
      cartRow.querySelector(".cart-price").innerText.replace("$", "")
    );
    var cart_quantity = cartRow.querySelector(".cart-quantity-input").value;

    sum = sum + cart_price * cart_quantity;
